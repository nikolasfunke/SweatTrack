    ...
    <div className="min-h-screen bg-surface-0 overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-5 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          <Botao variant="ghost" size="sm" onClick={() => navigate('/login')}>Entrar</Botao>
          <Botao variant="primary" size="sm" onClick={() => navigate('/cadastro')}>
            Começar grátis
          </Botao>
        </div>
      </nav>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pb-24">
        ...
        >
          ...
          <Botao variant="primary" size="lg" onClick={() => navigate('/cadastro')} className="mx-auto min-w-[200px]">
