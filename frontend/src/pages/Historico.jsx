...
export default function Historico() {
  ...
  return (
    <LayoutApp>
      <Cabecalho title="Histórico" actions={
        <button
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <Cartao key={label} className="text-center p-3">
          ...
          <div className="space-y-2">
            {isVirgin ? (
              ...
              filtered.map((s, i) => (
                ...
                >
                  <CartaoSessao session={s} onClick={() => handleSessionClick(s)} />
                </motion.div>
              ))
            )}
          </div>
  ...
  return (
    <div className="space-y-4 -mt-1">
      ...
      <div className="grid grid-cols-2 gap-2.5 pt-1">
        <Botao variant="outline" onClick={onClose}>Fechar</Botao>
        <Botao variant="primary" icon={<Download size={15} />} onClick={() => printSessionReport(session)}>
          Exportar PDF
        </Botao>
      </div>
    </div>
