...
import EscalaUrina from '../components/charts/EscalaUrina';
...
export default function PreSessao() {
  ...
  return (
    <LayoutApp>
      <Cabecalho title="Pré-Sessão" showBack />
      <div className="page-container md:max-w-2xl">
        <motion.div variants={stagger} initial="initial" animate="animate" className="space-y-5">
          ...
          <motion.div variants={fadeUp} className="grid grid-cols-2 gap-3 pb-4">
            <Botao variant="outline" onClick={handleSave} loading={saving}>
              Salvar Dados
            </Botao>
            <Botao variant="primary" size="lg" onClick={handleStart} loading={starting}>
              Iniciar Sessão
            </Botao>
          </motion.div>
        </motion.div>
