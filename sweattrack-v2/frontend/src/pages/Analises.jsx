...
import { printAnalyticsReport } from '../utils/imprimirRelatorio';
...
import { formatDuration } from '../utils/calculos';
        ...
        <motion.div variants={stagger} initial="initial" animate="animate" className="space-y-5">
          ...
          <motion.div variants={fadeUp} className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <Cartao key={label} className="!p-3.5">
              ...
              {hydrationIndex !== null ? (
                <>
                  <div className="flex items-center justify-center py-2">
                    <MedidorHidratacao value={hydrationIndex} size={160} />
                  </div>
                ...
                <EmptyChart message="O índice de hidratação é calculated a partir da coloração da urina registrada em cada sessão." />
              )}
            </Cartao>
          ...
          <motion.div variants={fadeUp}>
            <Cartao>
              ...
              <GraficoSemanal weeklyData={dashboard?.weeklyData} />
            </Cartao>
          </motion.div>
